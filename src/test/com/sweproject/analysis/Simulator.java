...
public class Simulator extends UIController {
    ...
    void simulate() {
        try {
            ...
            var rr = Utils.MRR(meanTrees, solutions, steps);
            double mrr = 0;
            ...
            for (int i = 1; i < 6; i++) {
                double accuracy = Utils.topXaccuracy(meanTrees, solutions, i, steps);
    ...
    private float updateContObservation(Event event, LocalDateTime
            contact_time, ArrayList<Event> tests, ArrayList<Event> symptoms, ArrayList<Subject> ss) throws
            Exception {
    ...
    void retrieveObservations
    (ArrayList<Subject> subjects, ArrayList<String> subjects_String, HashMap<String, ArrayList<HashMap<String, Object>>> clusterSubjectsMet,
    ...
    HashMap<String, HashMap<Integer, Double>> buildSolution
    (ArrayList<HashMap<String, HashMap<Integer, Double>>> pns, ArrayList<String> subjects_String) {
        return buildSolution(pns, subjects_String, samples, steps);
    }

    HashMap<String, HashMap<Integer, Double>> buildSolution
            (ArrayList<HashMap<String, HashMap<Integer, Double>>> pns, ArrayList<String> subjects_String,
             int samples, int steps) {
    ...
    private void printWhoShouldBeTested
            (HashMap<String, TreeMap<LocalDateTime, Double>> tt, HashMap<String, HashMap<Integer, Double>> ss) {
        try {
